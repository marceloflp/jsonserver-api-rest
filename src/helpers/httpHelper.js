export const httpHelper = () => {
	const customFetch = async (url, options = {}) => {
		...
		// AbortController é uma API que fornece uma maneira de abortar operações assíncronas. 
		// É comumente usado para cancelar solicitações de rede que estão demorando demais
